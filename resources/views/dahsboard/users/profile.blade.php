      ...
      <div class="col-md-3">
        ...
        <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle user_picture" src="{{ Auth::user()->picture }}" alt="User profile picture user_picture">
              <h3 class="profile-username text-center">{{ Auth::user()->name }}</h3>
              <input type="file" name="user_image" id="user_image" style="opacity:0; height:1px; none">
                ...
                <form class="form-horizontal" action="{{ route('userChangePassword') }}" method="POST" id="changePasswordUserForm">
                    ...
                    <div class="form-group row">
                        <label for="confirmNewPassword" class="col-sm-2 col-form-label">Confirm New
                            Password</label>
                        <div class="col-sm-10">
                            <input type="password" name="cnewpassword" class="form-control" id="cnewpassword"
